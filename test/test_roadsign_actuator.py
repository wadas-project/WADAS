...
def test_send_command_valid():
    ...
    command = Command(actuator.id, RoadSignActuator.Commands.DISPLAY_ON.value)
...
def test_actuate():
    ...
    actuator = RoadSignActuator(id="TestActuator", enabled=True)
    ...
    assert cmd_value == RoadSignActuator.Commands.DISPLAY_ON.value
